...
public final class DoraMachinesBlocks {
    public static void initialize() {
        ...
        RebarBlock.register(DoraMachinesKeys.TIMING_CHARGER, Material.RED_GLAZED_TERRACOTTA, RedstoneClock.class);
        ...
        RebarBlock.register(DoraMachinesKeys.REDSTONE_CLOCK, Material.RED_CONCRETE, RedstoneClock.class);
        ...
        if (Bukkit.getPluginManager().getPlugin("RebarWrench") != null) {
            ...
            RebarWrench.registerWrenchable(MultiFluidTank.class, Wrenchable.builder()
                .interactFunction(NormalWrench::onWrench).build());
            RebarWrench.registerWrenchable(RedstoneClock.class, Wrenchable.builder()
                .interactFunction(NormalWrench::onWrench).build());
